...
export function KaggleIcon({ className = "w-4 h-4", ...props }) {
  return (
    <svg
      role="img"
      viewBox="0 0 24 24"
...
export function LeetCodeIcon({ className = "w-4 h-4", ...props }) {
  return (
    ...
    >
      ...
      <path d="M8 8.5V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" />
      <path d="M18 19.5V20a2 2 0 0 1-2 2h-4a2 2 0 0 1-2-2v-4.5" />
    </svg>
  );
}
